    ...
    return (
        <>
            ...
            <section className="flex flex-col items-end flex-1 w-full h-full">
                <div className="bg-teddy bg-no-repeat bg-cover bg-center  mt-28 h-3/5">
            ...
            <section className="flex flex-col tracking-widest">
                <div className="mx-64 text-lg">
                    <p className="my-16">
                        ...
                        of na een ongeval, waar letselschade het gevolg van is. Gezondd kan
                    ...
                    <p className="mt-6">
                        Gezondd helpt een ondernemer bij zijn of haar re-integratie, als hij of zij
                    ...
                    <p className="my-12">
                        ...
                        Gezondd terecht voor beoordeling en begeleiding.
                    </p>
                    <p className="mt-12">
                        ...
                        verplicht zal stellen. Gezondd adviseert haar klanten, die werkzaam zijn als
                        zelfstandige of ondernemer, altijd een AOV af te sluiten, zelfs voordat deze
                        verplicht is gesteld vanuit de wet- en regelgeving. U kunt immers niet
                    ...
                    <p className="my-4">
                        ...
                        welke (medisch) specialist u kan helpen met uw specifieke zorgvraag. Gezondd
                        kan u goed en deskundig begeleiden en waar nodig doorverwijzen in het geval
                        van ziekte, arbeidsongeschiktheid of letselschade.
                    </p>
                </div>
            </section>
            <Partners />
